...
public class RepositorioFakeCompletarToDoAvisos implements IRepositorio
{
	...
	public RepositorioFakeCompletarToDoAvisos(boolean success, Collection<IToDo> expiredToDos, Collection<String> emails)
	{
